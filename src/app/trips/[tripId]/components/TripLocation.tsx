...
const TripLocation = ({ location, locationDescription }: TripLocationProps) => {
  return (
    <div className="p-5 lg:p-0 lg:mt-12 lg:pb-20">
      ...
      <h3 className="text-primaryDarker text-sm lg:text-base lg:mt-5 font-semibold mt-3">
        {location}
      </h3>
      <p className="text-xs lg:text-sm lg:mt-4 text-primaryDarker mt-2 leading-5">{locationDescription}</p>
