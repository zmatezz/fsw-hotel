...
const Trips = () => {
  ...
  return (
    <div className="container mx-auto flex flex-col items-center p-5 lg:pt-10 lg:justify-center">
      ...
      <div className="flex flex-col gap-4 lg:grid lg:grid-cols-4 lg:gap-10  lg:pb-16">
        {trips?.map((trip) => (
